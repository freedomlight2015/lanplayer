...
const TESTIMONIALS = [
  {
    content: `This LAN player is a game-changer! I can easily watch videos from my laptop on my phone without transferring files. Setup was super simple, and the video quality is spot on!`,
    author: {
      name: 'Clyde Edwards',
  ...
  {
    content: `I love that I don’t need to install anything on my other devices to watch videos. Just scan the QR code and boom, I’m watching 4K videos on my tablet like it’s nothing. So convenient!`,
    author: {
      name: 'Jimmy Hunter',
  ...
  {
    content: `Super impressed with how fast it detects other devices on my network. I had no issues streaming videos from my PC to my phone, and the quality didn’t drop at all. It’s a must-have for anyone sharing videos across devices!`,
    author: {
